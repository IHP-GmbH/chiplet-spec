...
found zero in 187 `.chiplet`. A sweep of 183 `.chiplet` across the umbrella
tree, build trees included, found zero lone CR as well, and no case in the
grammar oracle carried one before this rule landed.
